...
Route::group(['middleware' => 'auth'],function () {
    ...
    Route::get('/developers', App\Http\Livewire\Developer\DeveloperList::class)->name('developer-list')->middleware('can:viewAny,App\Models\Developer');
    ...
    Route::get('/properties', App\Http\Livewire\Property\PropertyList::class)->name('property-list')->middleware('can:viewAny,App\Models\Property');
